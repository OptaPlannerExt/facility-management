...
public class DemoDataBuilder {
    ...
    public FacilityLocationProblem build() {
        ...
        PrimitiveIterator.OfDouble latitudes = random.doubles(southWestCorner.latitude, northEastCorner.latitude+0.01)
                .iterator();
        PrimitiveIterator.OfDouble longitudes = random.doubles(southWestCorner.longitude, northEastCorner.longitude+0.1)
                .iterator();
